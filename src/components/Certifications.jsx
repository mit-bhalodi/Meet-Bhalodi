                ...
                <li>
                    <div className='flex flex-row justify-start gap-4'>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <p className="ext-base font-normal text-gray-500 dark:text-gray-400">Enjoyed this 7 part course from Ideation and Brainstorming to Prototyping and handover for development</p>
