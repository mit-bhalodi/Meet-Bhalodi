...
const items = [
    {
        ...
        header: <Skeleton src={"src/assets/resume_builder.png"} chips={["React", "Vite", "Firebase", "Tailwind", "React Query"]} />,
    ...
    },
    {
        ...
        header: <Skeleton src={"src/assets/sanskruti_store.png"} chips={["Angular 16", "Django", "Postgres", "Tailwind", "Amazon EC2" ]}/>,
    ...
    },
    {
        ...
        header: <Skeleton src={"src/assets/pass_gen.png"} chips={["React", "Tailwind", "Vite" ]} />,
    ...
    },
    {
        ...
        header: <Skeleton src={"src/assets/book_ex.png"} chips={["React", "Bootstrap", "Express", "Postgres", "Adbode XD" ]} />,
