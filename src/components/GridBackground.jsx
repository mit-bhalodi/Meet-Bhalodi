    ...
    return (
        <div className="h-full w-full dark:bg-gray-700 bg-gray-100 dark:bg-grid-gray/[0.1] bg-grid-black/[0.2] relative flex flex-col overflow-auto">
            <div className="h-full w-full flex flex-col items-center">
                {/* HERO SECTION */}
                <div className="py-28 grid grid-col-1 md:grid-cols-2 w-[900px]">
                    <div>
                        <ThreeDCardLive />
                    </div>
                    <div>
                        ...
                        <p className="text-4xl sm:text-7xl font-bold py-8 px-10 md:px-0 relative z-20 bg-clip-text text-transparent bg-gradient-to-t from-gray-600 via-gray-500 to-gray-700 dark:bg-gradient-to-t dark:from-gray-400 dark:to-white whitespace-normal">
